; ModuleID = '/home/theli11/workspace/courses/advanced_fpga_impl/code/mmult/hls/mmult/sol-mmult-def/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_mmult_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="4096" "maxi" %A, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="4096" "maxi" %B, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="4096" "maxi" %C) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mmult_hw([4096 x float]* %A_copy, [4096 x float]* %B_copy, [4096 x float]* %C_copy)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([4096 x float]* noalias, [4096 x float]* noalias readonly, [4096 x float]* noalias, [4096 x float]* noalias readonly, [4096 x float]* noalias, [4096 x float]* noalias readonly) unnamed_addr #4 {
entry:
...
declare void @apatb_mmult_hw([4096 x float]*, [4096 x float]*, [4096 x float]*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([4096 x float]* noalias, [4096 x float]* noalias readonly, [4096 x float]* noalias, [4096 x float]* noalias readonly, [4096 x float]* noalias, [4096 x float]* noalias readonly) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a4096f32([4096 x float]* %4, [4096 x float]* %5)
  ret void
}

define void @mmult_hw_stub_wrapper([4096 x float]*, [4096 x float]*, [4096 x float]*) #5 {
entry:
  call void @copy_out([4096 x float]* null, [4096 x float]* %0, [4096 x float]* null, [4096 x float]* %1, [4096 x float]* null, [4096 x float]* %2)
  %3 = bitcast [4096 x float]* %0 to float*
  %4 = bitcast [4096 x float]* %1 to float*
  %5 = bitcast [4096 x float]* %2 to float*
  call void @mmult_hw_stub(float* %3, float* %4, float* %5)
  call void @copy_in([4096 x float]* null, [4096 x float]* %0, [4096 x float]* null, [4096 x float]* %1, [4096 x float]* null, [4096 x float]* %2)
  ret void
}
