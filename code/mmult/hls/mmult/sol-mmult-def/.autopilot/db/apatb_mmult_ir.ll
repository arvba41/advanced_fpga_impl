...
define void @apatb_mmult_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" "maxi" %A, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" "maxi" %B, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1024" "maxi" %C) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mmult_hw([1024 x float]* %A_copy, [1024 x float]* %B_copy, [1024 x float]* %C_copy)
...
declare void @apatb_mmult_hw([1024 x float]*, [1024 x float]*, [1024 x float]*)
...
define void @mmult_hw_stub_wrapper([1024 x float]*, [1024 x float]*, [1024 x float]*) #5 {
entry:
