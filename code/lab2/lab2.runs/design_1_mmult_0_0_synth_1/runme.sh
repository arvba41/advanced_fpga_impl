...
HD_PWD='/home/theli11/workspace/courses/advanced_fpga_impl/code/lab2/lab2.runs/design_1_mmult_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mmult_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mmult_0_0.tcl
