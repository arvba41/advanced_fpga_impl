...
set genomeRtd $env(RT_TMP)/44EF06A0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {mmult_mmult_Pipeline_LOOP3_LOOP4__GB6}]"
...
set genomeName [subst -nocommands -novariables {mmult_mmult_Pipeline_LOOP3_LOOP4__GB6}]
