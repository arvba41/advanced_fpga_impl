...
-- 0x24 : reserved
-- 0x28 : Data signal of C_offset
--        bit 31~0 - C_offset[31:0] (Read/Write)
-- 0x2c : Data signal of C_offset
...
architecture behave of mmult_control_s_axi is
    ...
    constant ADDR_A_OFFSET_DATA_0 : INTEGER := 16#10#;
    constant ADDR_A_OFFSET_DATA_1 : INTEGER := 16#14#;
    constant ADDR_A_OFFSET_CTRL   : INTEGER := 16#18#;
    constant ADDR_B_OFFSET_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_B_OFFSET_DATA_1 : INTEGER := 16#20#;
    constant ADDR_B_OFFSET_CTRL   : INTEGER := 16#24#;
    constant ADDR_C_OFFSET_DATA_0 : INTEGER := 16#28#;
    constant ADDR_C_OFFSET_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_C_OFFSET_CTRL   : INTEGER := 16#30#;
